...
let githubLink = "https://github.com/kichristensen/FuncNet"

// Specify more information about your project
let info =
  [ "project-name", "FuncNet"
    "project-author", "Kim Christensen"
    "project-summary", "A functional approach to a .NET network framework"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FuncNet" ]
